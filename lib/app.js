...
var templates = root + '/lib/templates';
var __S = '/';

var renderTemplate = function(templateName, locals) {
    locals = locals || {};
    return jade.renderFile(templates + __S + templateName + '.jade', locals)
};
...
app.get('/', function(req, res) {
    res.render(root + '/lib/templates/application', { body: renderTemplate('chat')});
});
